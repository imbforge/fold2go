...
def ldap_hook(spawner, auth_state):
    ...
    # spawner.environment['NXF_USER_EMAIL'] = auth_state['mail']
    ...
    spawner.environment['NXF_USER_EMAIL'] = l.search_s(LDAP_DN, LDAP_SCOPE, LDAP_FILTER)[0][1]['mail'][0].decode('utf-8')
...
c.Spawner.workflow_url = "https://gitlab.rlp.net/imbforge/fold2go"
c.Spawner.auth_state_hook = ldap_hook
c.Spawner.args = ['--debug']
c.Spawner.debug = True
c.Spawner.env_keep = ['PATH', 'PYTHONPATH', 'CONDA_ROOT', 'CONDA_DEFAULT_ENV', 'VIRTUAL_ENV', 'LANG', 'LC_ALL', 'JUPYTERHUB_SINGLEUSER_APP', 'PIXI_PROJECT_MANIFEST', 'PIXI_ENVIRONMENT_NAME', 'PIXI_PROJECT_NAME', 'PIXI_PROJECT_ROOT', 'NXF_SCM_FILE']
